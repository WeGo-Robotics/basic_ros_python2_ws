...
class Class_Name:  # 1단계: 클래스 이름 정의
    ...
    def callback(self, msg):  # 3단계: 클래스 내의 콜백 함수 설정
        print(msg)  # 출력: 메세지
        print(msg.angle_min)  # 출력: 메세지 항목(angle_min)
        print(msg.angle_max)  # 출력: 메세지 항목(angle_max)
        print(msg.angle_increment)  # 출력: 메세지 항목(angle_increment)
        print(msg.range_min)  # 출력: 메세지 항목(range_min)
        print(msg.range_max)  # 출력: 메세지 항목(range_max)
        print(msg.ranges)  # 출력: 메세지 항목(ranges)
